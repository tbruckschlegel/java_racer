...
public class AseToJme extends FormatConverter{
     ...
     *
     * @author Mark Powell
     * @version $Id: AseToJme.java,v 1.1 2005/05/12 22:49:10 Mojomonkey Exp $
     */
    private static class ASEModelCopy extends Node{
         ...
         */
        private static class ASEMaterialInfo {
         ...
         */
        public static class ASEObject extends TriMesh {
            private static final long serialVersionUID = 1L;
