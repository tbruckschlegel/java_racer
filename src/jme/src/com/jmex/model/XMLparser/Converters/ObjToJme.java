...
public class ObjToJme extends FormatConverter{
    ...
    private void addFaces(String[] parts) {
        ...
        for (int i=3;i<parts.length;i++){
            ...
            thisMat.indexes.add(Integer.valueOf(firstIndex));
            thisMat.indexes.add(Integer.valueOf(secondIndex));
            int thirdIndex=thisMat.findSet(third);
            thisMat.indexes.add(Integer.valueOf(thirdIndex));
        }
    }
    ...
    private static class MaterialGrouping{
