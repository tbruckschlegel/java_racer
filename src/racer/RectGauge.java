...
public class RectGauge extends Node
{
    ...
    public RectGauge(String name, TextureState tex[], float gaugeSize, float pointerWidth, float pointerHeight)
    {
        super(name);
        init();
...
//      default texture for the pointer.
        ...
        pointer.setLocalTranslation(new Vector3f(0, -midPoint.x * pointerHeight*0.5f, 0));
