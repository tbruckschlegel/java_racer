...
public class Ode implements OdeConstants {
  ...
  public static SWIGTYPE_p_dGeomID dCreateCCylinder(SWIGTYPE_p_dSpaceID space, float radius, float length) {
    return new SWIGTYPE_p_dGeomID(OdeJNI.dCreateCCylinder(SWIGTYPE_p_dSpaceID.getCPtr(space), radius, length), true);
  }

  public static void dGeomCCylinderSetParams(SWIGTYPE_p_dGeomID ccylinder, float radius, float length) {
    OdeJNI.dGeomCCylinderSetParams(SWIGTYPE_p_dGeomID.getCPtr(ccylinder), radius, length);
  }

  public static void dGeomCCylinderGetParams(SWIGTYPE_p_dGeomID ccylinder, SWIGTYPE_p_float radius, SWIGTYPE_p_float length) {
    OdeJNI.dGeomCCylinderGetParams(SWIGTYPE_p_dGeomID.getCPtr(ccylinder), SWIGTYPE_p_float.getCPtr(radius), SWIGTYPE_p_float.getCPtr(length));
  }

  public static float dGeomCCylinderPointDepth(SWIGTYPE_p_dGeomID ccylinder, float x, float y, float z) {
    return OdeJNI.dGeomCCylinderPointDepth(SWIGTYPE_p_dGeomID.getCPtr(ccylinder), x, y, z);
  }
  ...
  public static void dGeomTriMeshDataDestroy(SWIGTYPE_p_dxTriMeshData g) {
   ...
   /**
    * build trimesh data for ode
    * @param g receiving structure
    * @param Vertices float pointer to the vertex array
    * @param VertexStride number of bytes the vertices are spread in the native float array (FIXME: platform dependent!!!)
    * @param VertexCount number of vertices (not the number of floats in the array!)
    * @param Indices int pointer to indices
    * @param IndexCount number of indices (not number of vertices!)
    * @param TriStride number of bytes the vertices are spread in the native float array (FIXME: platform dependent!!!) 
    */
  ...
  public static SWIGTYPE_p_dGeomID dCreateTriMesh(SWIGTYPE_p_dSpaceID space, SWIGTYPE_p_dxTriMeshData Data, SWIGTYPE_p_f_dGeomID_dGeomID_int__int Callback, SWIGTYPE_p_f_dGeomID_dGeomID_p_q_const__int_int__void ArrayCallback, SWIGTYPE_p_f_dGeomID_dGeomID_int_float_float__int RayCallback) {
    return new SWIGTYPE_p_dGeomID(OdeJNI.dCreateTriMesh(SWIGTYPE_p_dSpaceID.getCPtr(space), SWIGTYPE_p_dxTriMeshData.getCPtr(Data), SWIGTYPE_p_f_dGeomID_dGeomID_int__int.getCPtr(Callback), SWIGTYPE_p_f_dGeomID_dGeomID_p_q_const__int_int__void.getCPtr(ArrayCallback), SWIGTYPE_p_f_dGeomID_dGeomID_int_float_float__int.getCPtr(RayCallback)), true);
  }
  ...
  public static SWIGTYPE_p_dGeomID dGeomGetBodyNext(SWIGTYPE_p_dGeomID arg0) {
    return new SWIGTYPE_p_dGeomID(OdeJNI.dGeomGetBodyNext(SWIGTYPE_p_dGeomID.getCPtr(arg0)), true);
  }
  ...
  public static void dMassSetCappedCylinder(SWIGTYPE_p_dMass arg0, float density, int direction, float radius, float length) {
    OdeJNI.dMassSetCappedCylinder(SWIGTYPE_p_dMass.getCPtr(arg0), density, direction, radius, length);
  }

  public static void dMassSetCappedCylinderTotal(SWIGTYPE_p_dMass arg0, float total_mass, int direction, float radius, float length) {
    OdeJNI.dMassSetCappedCylinderTotal(SWIGTYPE_p_dMass.getCPtr(arg0), total_mass, direction, radius, length);
  }
